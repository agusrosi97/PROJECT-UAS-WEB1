	    ...
	    <div id="content">
	        <nav class="navbar navbar-expand-lg navbar-light bg-light">
	            <div class="container-fluid">
	                ...
	                <h1 class="h1-title-header-tamu">DATA TAMU</h1>
	        ...
	        <div class="container table-mg-top">
				<div class="wrapper-table">
					<div class="bungkus-bt-new">
	        			<button class="btn btn-outline-secondary bt-input" data-toggle="modal" data-target="#popUpInsert-Tamu"><i class="fas fa-plus"></i>Data Tamu</button>
	        		</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
		    $('#btn-sidebar-toggle').on('click', function () {
                ...
                $('.h1-title-header-tamu').toggleClass('increase-width');
