...
<body>
	        ...
	        <div class="container table-mg-top">
				<div class="wrapper-table">
					<div class="bungkus-bt-new">
	        			<button class="btn btn-outline-primary bt-input" data-toggle="modal" data-target="#popUpInsert-Reservasi"><i class="fas fa-plus"></i>Data Reservasi</button>
	        		</div>
								...
								foreach ($koneksi->query($sql) as $row) {
									...
									<tr>
							    		...
							    		<td class="text-nowrap" align="center">
							    			<a href='#popUpRead-Reservasi_<?php echo $row['id_reservasi']; ?>' data-toggle='modal' title='Lihat Data' data-target='#popUpRead-Reservasi_<?php echo $row['id_reservasi']; ?>'>
												<button class='btn btn-outline-success btn-data-aksi'>
													<i class='far fa-eye'></i>
												</button>
											</a>
											<a href='#popUpUpdate-Reservasi_<?php echo $row['id_reservasi']; ?>' data-toggle='modal' title='Edit Data' data-target='#popUpUpdate-Reservasi_<?php echo $row['id_reservasi']; ?>'>
												<button class='btn btn-outline-primary btn-data-aksi'>
													<i class='fas fa-pen'></i>
												</button>
											</a>
											<a href='#popUpDelete-Reservasi_<?php echo $row['id_reservasi']; ?>' data-toggle='modal' title='Hapus Data' data-target='#popUpDelete-Reservasi_<?php echo $row['id_reservasi']; ?>'>
					    			...
					    			<?php 
					    			include 'modal_read_reservasi.php'; include 'modal_update_reservasi.php'; include 'modal_delete_reservasi.php';
					    		$no++;
					    		}
					    	?>
				        </tbody>
	...
	<?php include 'modal_input_reservasi.php'; ?>
	<!-- JS - JQ -->
	<!-- JS LIBRARY GLOBAL -->
