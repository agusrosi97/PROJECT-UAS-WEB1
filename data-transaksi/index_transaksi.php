...
<body>
								...
								foreach ($koneksi->query($sql) as $row) {
									...
									<tr>
							    		...
							    		<td class="text-nowrap" align="center">
							    			<a href='#popUpRead-Transaksi_<?php echo $row['id_transaksi']; ?>' data-toggle='modal' title='Lihat Data' data-target='#popUpRead-Transaksi_<?php echo $row['id_transaksi']; ?>'>
					    			...
					    			<?php 
					    			include 'modal_read_transaksi.php';
					    		$no++;
					    		}
					    	?>
				        </tbody>
	...
	<?php include 'modal_input_transaksi.php'; ?>
	<!-- JS - JQ -->
	<!-- JS LIBRARY GLOBAL -->
