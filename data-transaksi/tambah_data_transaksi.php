...
<?php 
	...
	$total_transaksi = $_POST['inp_total_transaksi'];
	//insert data to database
	$sql = "INSERT INTO tb_transaksi (nama_tamu, checkin, checkout, tipe_kamar, jml_dewasa, jml_anak, total_pembayaran) VALUES (:inp_nm_tamu, :inp_checkin_reservasi, :inp_checkout_reservasi, :inp_tipe_kamar, :inp_jmldwsa_reservasi, :inp_jmlanak_reservasi, :inp_total_transaksi)";
	...
	$query->bindparam(':inp_total_transaksi', $total_transaksi);
	$query->execute();
	echo "<script>
		Swal.fire({
		    type: 'success',
			...
			window.location.href = 'index_transaksi.php';
		})
	</script>";
?>